...
//                 <h2 className="font-bold text-sm sm:text-base text-slate-900">{filter === 'ALL' ? 'All Leads' : STATUS_CONFIG[filter]?.label + ' Leads'}</h2>
//                 {search && (
...
//               {/* Responsive Layout Table View Container */}
...
//                             {/* Grid Card / Row Actions */}
//                             <td className="px-0 md:pr-6 py-2 md:py-3.5 block md:table-cell md:text-right">
...
//           <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[calc(100vh-2rem)]">
...
//                 className={`px-3 py-2 text-xs sm:text-sm font-bold border-b-2 transition-all ${notesTab === 'view' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-800'}`}
//               >
//                 View Notes
//               </button>
//               <button
...
//                   setNotesTab('add');
//                 }}
//                 className={`px-3 py-2 text-xs sm:text-sm font-bold border-b-2 transition-all ${notesTab === 'add' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-800'}`}
//               >
...
//               <button type="button" onClick={() => setModal(false)} className="flex-1 py-2 bg-white border border-slate-200 text-slate-700 font-bold rounded-xl hover:bg-slate-100 text-xs">Cancel</button>
//               <button type="button" onClick={handleSave} className="flex-1 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl text-xs">{isEditing ? 'Save Changes' : 'Create Lead'}</button>
//             </div>
//           </div>
//         </div>
//       )}
